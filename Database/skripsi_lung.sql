...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2023 at 10:04 AM
...
CREATE TABLE `order` (
  ...
  `status_order` varchar(255) DEFAULT 'NEW'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `order` (`id_order`, `id_pelanggan`, `id_sales`, `tanggal_pesanan`, `no_order`, `pembayaran`, `down_payment`, `tanggal_pembayaran`, `tanggal_pengiriman`, `catatan`, `status_order`) VALUES
(7, 1, 2, '2023-09-06', 'BRZ-1234567890123', 'CASH', 'DERFTT-1234565679', '2023-09-19', '2023-09-14', 'HAHAHOHO', 'NEW');
...
(1, 'yong', 'abc', '081999999', 'bca', '82200000', 'yong123', 'anjay123', '-7.2415222', '112.7491385'),
(2, 'Denny', 'Babatan pantai', '1234567890', 'Mandiri', '2345678910', 'Levina', 'Charin', '-7.3404937', '112.7533363');
...
ALTER TABLE `detail_retur_barang`
  ...
  ADD KEY `id_detail_retur` (`id_detail_retur`),
  ADD KEY `id_ukuran` (`id_ukuran`);
...
ALTER TABLE `detail_retur`
  ...
  ADD CONSTRAINT `detail_retur_ibfk_2` FOREIGN KEY (`id_stock`) REFERENCES `stock` (`id`);

--
-- Constraints for table `detail_retur_barang`
--
ALTER TABLE `detail_retur_barang`
  ADD CONSTRAINT `detail_retur_barang_ibfk_1` FOREIGN KEY (`id_detail_retur`) REFERENCES `detail_retur` (`id_detail_retur`),
  ADD CONSTRAINT `detail_retur_barang_ibfk_2` FOREIGN KEY (`id_ukuran`) REFERENCES `ukuran` (`id_ukuran`);
...
ALTER TABLE `order`
  ...
  ADD CONSTRAINT `order_ibfk_2` FOREIGN KEY (`id_sales`) REFERENCES `user` (`id_user`);

--
-- Constraints for table `retur`
--
ALTER TABLE `retur`
  ADD CONSTRAINT `retur_ibfk_1` FOREIGN KEY (`id_sales`) REFERENCES `user` (`id_user`),
  ADD CONSTRAINT `retur_ibfk_2` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id_pelanggan`);
